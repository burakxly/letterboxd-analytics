...
import InsightsLeft from "@/components/InsightsLeft";
import InsightsRight from "@/components/InsightsRight";
...
// InsightsLeft and InsightsRight are client components — see components/InsightsLeft.tsx and components/InsightsRight.tsx
      ...
      <ScrollReveal>
        <div style={{ marginBottom: "48px" }}>
          ...
          <div className="grid-insights">
            <InsightsLeft marathon={insights.marathon} time_wasted={insights.time_wasted} />
            <div className="grid-insights-divider" />
            <InsightsRight peak_month={insights.peak_month} best_decade={insights.best_decade} favorite_day={insights.favorite_day} />
          </div>
        </div>
      </ScrollReveal>
